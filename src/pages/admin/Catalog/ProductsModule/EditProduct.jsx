...
const EditProduct = () => {
  ...
  const handleFinalSave = async () => {
    ...
    try {
      ...
      const productRes = await axios.put(`${import.meta.env.PROD ? '' : 'http://localhost:8000'}/admin/products/${id}`, productPayload, {
      ...
      if (variantsPayload.length > 0) {
         const varRes = await axios.put(`${import.meta.env.PROD ? '' : 'http://localhost:8000'}/admin/products/${id}/variants`, { variants: variantsPayload }, {
           withCredentials: true
         });
