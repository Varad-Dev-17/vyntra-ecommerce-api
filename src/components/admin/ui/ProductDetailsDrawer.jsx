      ...
      const fetchAttributes = async () => {
        ...
        try {
          const [attrRes, optRes] = await Promise.all([
            axios.get(`${(import.meta.env.PROD ? '' : 'http://localhost:8000')}/attributes`, { params: { limit: 1000 }, withCredentials: true }),
            axios.get(`${(import.meta.env.PROD ? '' : 'http://localhost:8000')}/attribute-options`, { withCredentials: true })
          ]);
