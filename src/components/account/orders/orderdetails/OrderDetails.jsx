    ...
    <div className="max-w-2xl mx-auto py-6 px-4 sm:px-6">
      ...
      <div className="space-y-6">
          ...
          return (
            <div key={index} className="flex flex-col mb-8">
              ...
              <div className="flex flex-col items-center text-center pb-6">
                <div className="w-24 h-32 bg-gray-100 rounded-2xl overflow-hidden shadow-sm mb-4">
                  <img 
                ...
                <p className="text-[13px] text-gray-500 mt-1">{item.product?.title}</p>
                <div className="text-[12px] text-gray-500 mt-1 flex items-center justify-center gap-1 font-medium">
                  {size && <span>Size: {size}</span>}
                  {size && <span className="mx-1">•</span>}
                  <span>Quantity: {item.quantity}</span>
                </div>
                <div className="text-[12px] text-gray-400 mt-1.5 font-medium">
                  Order ID: # {order.orderId || order._id.toString().slice(-8)}
                </div>
              </div>

              {/* Status Banner */}
              <div className={`${getStatusBannerColor(order.status)} rounded-xl px-5 py-4 flex items-center justify-between mb-4 shadow-sm relative overflow-hidden`}>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 px-5 py-4 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-1 mt-1 text-gray-200">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <button key={star} className="hover:text-yellow-400 transition-colors">
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-5 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-[13px] text-gray-500">{order.shippingAddress.name}</p>
              </div>
            </div>
            ...
            <div className="pl-13 space-y-4 ml-2 border-l-2 border-gray-50">
              ...
              <div className="flex gap-3 pl-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[12px] text-gray-500 mt-0.5 pr-12 relative leading-relaxed">
        ...
        <div className="bg-white border border-gray-100 rounded-xl p-5 shadow-sm">
          ...
          <p className="text-[11px] text-gray-400 mt-4 mb-3">Item sold by: Vyntra Retail</p>
          <button className="w-full py-2.5 border border-gray-200 rounded-lg text-[13px] font-bold text-gray-700 hover:bg-gray-50 transition-colors">
            Get Invoice
          </button>
        </div>
        ...
        <div className="bg-white border border-gray-100 rounded-xl p-5 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-4 pl-6 text-[12px]">
            <div>
              <p className="text-gray-400 mb-1">Call</p>
              <p className="font-medium text-gray-900">{order.shippingAddress?.phone || order.user?.phone || '-'}</p>
            </div>
            <div>
              <p className="text-gray-400 mb-1">Email</p>
              <p className="font-medium text-gray-900 truncate pr-2">{order.user?.email}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-100 rounded-xl p-5 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-4 pl-6 text-[12px]">
            <div>
              <p className="text-gray-400 mb-1">Ordered On</p>
