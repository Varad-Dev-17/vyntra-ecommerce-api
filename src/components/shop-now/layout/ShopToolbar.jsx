    ...
    <div className="flex flex-col sm:flex-row items-center justify-between pb-4 mb-4 border-b border-[#E5E7EB]">
      ...
      <div className="flex items-center gap-4 sm:gap-6 w-full sm:w-auto justify-between sm:justify-end">
        ...
        <div className="flex items-center gap-2 flex-1 sm:flex-none justify-end">
          ...
          <select value={sort || "newest"} onChange={onSortChange} className="border border-[#E5E7EB] rounded-lg text-[15px] text-[#111827] py-2 px-3 focus:outline-none focus:ring-2 focus:ring-[#6D4AFF]/20 focus:border-[#6D4AFF] cursor-pointer transition-all duration-300 bg-white min-w-[140px]">
